/*! Categorizr.js: Device Detection Scripts | https://github.com/Skookum/categorizr.js/blob/master/license.md ### SRF-CMS FORK: https://github.com/mmz-srf/categorizr.js */
...
(function (name, context, definition) {
    ...
    var key // used in a loop below
        ...
        , os = function () {
            ...
            return ua.match(/android/i) ? 'android'
                : ua.match(/(iPad|iPhone|iPod)/i) ? 'ios'
                : 'unknown';
        }
    ...
    function _update() {
        ...
        if (eventEmitter) context.$(context).trigger('deviceChange', [
            { type: device }
        ])
    }
